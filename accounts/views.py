...
def register (request):
    ...
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            mail_subject= "Por favor activa tu cuenta en mi E-commerce"
            ...
            #se envio el mensage correctamente
...
def edit_profile(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            return redirect('edit_profile') # Redirigir para evitar el envío duplicado del formulario
    else:
...
#cambiar password en el perfil si esta logueado
@login_required(login_url='login')
    ...
    if request.method =='POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                ...
                return redirect('change_password')
        else: messages.error(request,"El password no conicide con la confirmacion ")
        return redirect('change_password')
